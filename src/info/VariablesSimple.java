...
public class VariablesSimple extends javax.swing.JFrame {
    String archivo;
    String cuerda;
    AFD comandos=new AFD();
    int cont=0;
    
    public VariablesSimple() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nombre de su variable:");
            ...
            if (cont==0) {
                ...
                if (comandos.pasoOne(cuerda)) {
                    if (comandos.pasoTwo(cuerda)) {
                        jTextArea1.append("VARIABLE " + cuerda + ": ACEPTADA\n");
                        textField1.selectAll();
                    }
                    else {
                        jTextArea1.append("VARIABLE " + cuerda + ": NO ACEPTADA\n");
                        textField1.selectAll();
                    }
                } else {
                    jTextArea1.append("VARIABLE " + cuerda + ": NO ACEPTADA\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VariablesSimple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VariablesSimple().setVisible(true);
            }
        });
    }
