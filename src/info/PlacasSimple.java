...
public class PlacasSimple extends javax.swing.JFrame {
    String archivo;
    String cuerda;
    ...
    private void initComponents() {
        ...
        setTitle("Analizador de Placas");

        jLabel1.setText("Ingrese su placa:");
        ...
        jLabel2.setText("Listado de Placas:");
    ...
    private void textField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textField1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (cont==0) {
                comandos.readAdd("placasConfig.txt");
                cont++;
                textField1.selectAll();
                cuerda = textField1.getText();
                if (comandos.pasoOne(cuerda)) {
                    if (comandos.pasoTwo(cuerda)) {
                        jTextArea1.append("PLACA " + cuerda + ": ACEPTADA\n");
                        textField1.selectAll();
                    }
                    else {
                        jTextArea1.append("PLACA " + cuerda + ": NO ACEPTADA\n");
                        textField1.selectAll();
                    }
                } else {
                    jTextArea1.append("PLACA " + cuerda + ": NO ACEPTADA\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlacasSimple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlacasSimple().setVisible(true);
            }
        });
    }
